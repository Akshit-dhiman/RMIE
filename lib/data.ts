...
export const CORE_OFFERINGS = [
  ...
  {
    title: 'Heat Shrink Sleeve',
    description: 'Protective heat shrink sleeves for cable management',
    category: 'Heat Shrink Sleeve',
  },
  {
    title: 'Wiring Harness Tape',
    description: 'Professional-grade harness tape for bundling and protection',
    category: 'Wiring Harness Tape',
  },
]
